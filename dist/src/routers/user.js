...
// Get user
router.get('/users/me', auth, /*#__PURE__*/function () {
...
// Logout a user
router.post('/users/logout', auth, /*#__PURE__*/function () {
...
router.post('/users/logoutAll', auth, /*#__PURE__*/function () {
...
// Update a user
router.patch('/users/me', auth, /*#__PURE__*/function () {
...
// Delete a user
router["delete"]('/users/me', auth, /*#__PURE__*/function () {
...
router.post('/users/me/avatar', auth, upload.single('avatar'), /*#__PURE__*/function () {
...
// Delete user image
router["delete"]('/users/me/avatar', auth, /*#__PURE__*/function () {
