...
// Create a new order
router.post('/orders', auth, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var order;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          order = new Order(_objectSpread({}, req.body));
          _context.prev = 1;
          _context.next = 4;
          return order.save();
        case 4:
...
// Update order
router.patch('/order/:id', adminAuth, /*#__PURE__*/function () {
...
// Delete order
router["delete"]('/orders/:id', adminAuth, /*#__PURE__*/function () {
...
// GET USER ORDER
router.get('/orders/me', auth, /*#__PURE__*/function () {
...
router.get('/allOrders', adminAuth, /*#__PURE__*/function () {
...
// GET MONTHLY INCOME
router.get("/orders/income", adminAuth, /*#__PURE__*/function () {
